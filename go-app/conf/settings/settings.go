...
var (
	settingsNotFound   = errors.New("settings not found")
	missingBucketError = errors.New("missing bucket")
)
...
var initialConfiguration = Settings{
	DebugEnabled:           false,
	SecondsBetweenCaptures: conf.SecondsBetweenCaptures,
	OffsetWithinHour:       conf.DefaultOffsetWithinHour,
