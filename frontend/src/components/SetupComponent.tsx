...
export default function SetupComponent() {
  ...
  const handleObjectDetectionToggle = (e: ChangeEvent<HTMLInputElement>) => {
      ...
      <Card sx={{ mb: 2 }}>
        <CardContent>
          ...
          <Grid container spacing={2}>
            ...
            <Grid size={6}>
              <Typography component={'span'} gutterBottom>Object Detection (YOLO):</Typography>
            </Grid>
            <Grid size={6}>
              {editMode ? (
                <FormControlLabel
                  control={
                    <Switch
                      ...
                      onChange={handleObjectDetectionToggle}
                    />
                  }
